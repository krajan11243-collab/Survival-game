...
Using this SDK in conjunction with [Matchmaker](https://docs.unity.com/ugs/en-us/manual/matchmaker/manual/advanced-topics-QoS) can enable matchmaking that considers clients' latency
...
try
{
    ...
    var qosResults = await QosService.Instance.GetSortedQosResultsAsync("relay", regions);
}
catch (Exception e)
{
    Debug.Log(e);
