...
namespace Unity.Services.Multiplayer.Editor.Matchmaker.Authoring.AdminApi.Matchmaker.Model
{
    ...
    partial class MultiplayHostingConfig
    {
        ...
        /// <param name="moduleName">The name of the Cloud Code module..</param>
        ...
        [Preserve]
        public MultiplayHostingConfig(TypeEnum? type = default(TypeEnum?), string buildConfigurationId = default(string), string fleetId = default(string), string defaultQoSRegionId = default(string), string moduleName = default(string), string allocateFunctionName = default(string), string pollFunctionName = default(string))
        {
            this.Type = type;
