...
namespace Unity.Services.Matchmaker.Models
{
    ...
    internal class TicketStatusResponseOneOf : IOneOf
    {
        ...
        {
            { "CustomAssignment", typeof(CustomAssignment) },
            { "IpPortAssignment", typeof(IpPortAssignment) },
            { "MatchIdAssignment", typeof(MatchIdAssignment) },
            { "MultiplayAssignment", typeof(MultiplayAssignment) },
            { "None", typeof(NoneAssignment) },
        };
        private static List<Type> PossibleTypes = new List<Type>(){ typeof(CustomAssignment) , typeof(IpPortAssignment) , typeof(MatchIdAssignment) , typeof(MultiplayAssignment) , typeof(NoneAssignment)  };
    ...
    internal class TicketStatusResponseOneOfJsonConverter : JsonConverter
    {
        ...
        {
            return objectType == typeof(TicketStatusResponseOneOf);
        }
    }
}
