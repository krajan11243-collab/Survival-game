...
namespace Unity.Services.Matchmaker.Models
{
    ...
    internal class CreateBackfillTicketRequest
    {
        ...
        /// <param name="connectionDetails">connectionDetails param</param>
        ...
        [Preserve]
        public CreateBackfillTicketRequest(Dictionary<string, byte[]> properties, string queueName = default, string connection = default, ConnectionDetails connectionDetails = default, Dictionary<string, object> attributes = default, string poolId = default, string matchId = default)
        {
            QueueName = queueName;
        ...
        /// <summary>
        /// Parameter connectionDetails of CreateBackfillTicketRequest
        /// </summary>
        [Preserve]
        ...
        internal string SerializeAsPathParam()
        {
            ...
            {
                serializedModel += "connectionDetails," + ConnectionDetails.ToString() + ",";
            }
            if (Attributes != null)
            {
