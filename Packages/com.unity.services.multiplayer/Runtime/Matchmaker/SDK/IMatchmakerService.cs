...
namespace Unity.Services.Matchmaker
{
    ...
    public interface IMatchmakerService
    {
        ...
        /// <summary>
        /// Returns the backfill ticket id wrapped in a <see cref="CreateBackfillTicketResponse"/>.
        /// This should be called when backfill begins.
        /// </summary>
        /// <param name="options">
        /// Configuration parameters for creating a backfill ticket.
        /// </param>
        /// <returns>
        /// Task for a Response object that includes the identifier of the created backfill ticket.
        /// </returns>
        /// <exception cref="System.ArgumentNullException">
        /// Thrown when <paramref name="options"/> is <c>null</c>.
        /// </exception>
        /// <exception cref="Multiplayer.SessionException">
        /// Thrown with error code <see cref="Multiplayer.SessionError.InvalidBackfillTicketOptions">InvalidBackfillTicketOptions</see> when neither <see cref="CreateBackfillTicketOptions.Connection">Connection</see> nor <see cref="CreateBackfillTicketOptions.ConnectionDetails">ConnectionDetails</see> is set.
        /// </exception>
        /// <exception cref="Unity.Services.Matchmaker.MatchmakerServiceException">
        /// An exception for the Matchmaker SDK containing reason for failure, messages, and any inner exceptions.
        /// </exception>
