...
namespace Unity.Services.Lobbies.Lobby
{
    ...
    internal class BulkUpdateLobbyRequest : LobbyApiBaseRequest
    {
        ...
        /// <summary>Accessor for ifMatch </summary>
        [Preserve]
        ...
        /// <param name="ifMatch">The etag of the record being requested. Results/actions are only returned/executed when the current record version matches the provided value.</param>
        /// <param name="bulkUpdateRequest">BulkUpdateRequest param</param>
        [Preserve]
        public BulkUpdateLobbyRequest(string lobbyId, string serviceId = default(string), string impersonatedUserId = default(string), string ifMatch = default(string), Unity.Services.Lobbies.Models.BulkUpdateRequest bulkUpdateRequest = default(Unity.Services.Lobbies.Models.BulkUpdateRequest))
        {
            LobbyId = lobbyId;
    ...
    internal class DeleteLobbyRequest : LobbyApiBaseRequest
    {
        ...
        /// <param name="ifMatch">The etag of the record being requested. Results/actions are only returned/executed when the current record version matches the provided value.</param>
        [Preserve]
        public DeleteLobbyRequest(string lobbyId, string serviceId = default(string), string impersonatedUserId = default(string), string ifMatch = default(string))
        {
            LobbyId = lobbyId;
    ...
    /// <summary>
    /// GetMigrationDataInfoRequest
    /// Get migration data information for a host&#39;s lobby
    /// </summary>
    [Preserve]
    internal class GetMigrationDataInfoRequest : LobbyApiBaseRequest
    {
        /// <summary>Accessor for lobbyId </summary>
        [Preserve]
        public string LobbyId { get; }
        ...
        /// <summary>
        /// GetMigrationDataInfo Request Object.
        /// Get migration data information for a host&#39;s lobby
        /// </summary>
        /// <param name="lobbyId">The ID of the lobby to execute the request against. It should be composed of 64 characters or less, and only have dashes, underscores and alphanumeric characters.</param>
        /// <param name="serviceId">When service authentication is used, this provides a logical identity for the service</param>
        /// <param name="impersonatedUserId">When service authentication is used, this provides a 'playerId' to execute as. If this header is detected, the service request will be identical to a request from the specified player.</param>
        [Preserve]
        public GetMigrationDataInfoRequest(string lobbyId, string serviceId = default(string), string impersonatedUserId = default(string))
        {
            LobbyId = lobbyId;
    ...
    internal class JoinLobbyByIdRequest : LobbyApiBaseRequest
    {
        ...
        [Preserve]
        public JoinLobbyByIdRequest(string lobbyId, string serviceId = default(string), string impersonatedUserId = default(string), string ifMatch = default(string), Unity.Services.Lobbies.Models.JoinByIdRequest joinByIdRequest = default(Unity.Services.Lobbies.Models.JoinByIdRequest))
        {
            LobbyId = lobbyId;
    ...
    internal class RemovePlayerRequest : LobbyApiBaseRequest
    {
        ...
        /// <param name="ifMatch">The etag of the record being requested. Results/actions are only returned/executed when the current record version matches the provided value.</param>
        [Preserve]
        public RemovePlayerRequest(string lobbyId, string playerId, string serviceId = default(string), string impersonatedUserId = default(string), string ifMatch = default(string))
        {
            LobbyId = lobbyId;
    ...
    internal class UpdateLobbyRequest : LobbyApiBaseRequest
    {
        ...
        [Preserve]
        public UpdateLobbyRequest(string lobbyId, string serviceId = default(string), string impersonatedUserId = default(string), string ifMatch = default(string), Unity.Services.Lobbies.Models.UpdateRequest updateRequest = default(Unity.Services.Lobbies.Models.UpdateRequest))
        {
            LobbyId = lobbyId;
    ...
    internal class UpdatePlayerRequest : LobbyApiBaseRequest
    {
        ...
        [Preserve]
        public UpdatePlayerRequest(string lobbyId, string playerId, string serviceId = default(string), string impersonatedUserId = default(string), string ifMatch = default(string), Unity.Services.Lobbies.Models.PlayerUpdateRequest playerUpdateRequest = default(Unity.Services.Lobbies.Models.PlayerUpdateRequest))
        {
            LobbyId = lobbyId;
