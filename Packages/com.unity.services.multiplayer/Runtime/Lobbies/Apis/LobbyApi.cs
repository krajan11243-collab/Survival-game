...
namespace Unity.Services.Lobbies.Apis.Lobby
{
    ...
    internal interface ILobbyApiClient
    {
            ...
            /// </summary>
            /// <param name="request">Request object for GetMigrationDataInfo.</param>
            /// <param name="operationConfiguration">Configuration for GetMigrationDataInfo.</param>
            /// <returns>Task for a Response object containing status code, headers, and Models.MigrationDataInfo object.</returns>
            /// <exception cref="Unity.Services.Lobbies.Http.HttpException">An exception containing the HttpClientResponse with headers, response code, and string of error.</exception>
            Task<Response<Models.MigrationDataInfo>> GetMigrationDataInfoAsync(Unity.Services.Lobbies.Lobby.GetMigrationDataInfoRequest request, Configuration operationConfiguration = null);
    ...
    internal class LobbyApiClient : BaseApiClient, ILobbyApiClient
    {
        ...
        {
            var statusCodeToTypeMap = new Dictionary<string, System.Type>() { {"200", typeof(Models.Lobby)   },{"400", typeof(Models.ErrorStatus)   },{"403", typeof(Models.ErrorStatus)   },{"404", typeof(Models.ErrorStatus)   },{"409", typeof(Models.ErrorStatus)   },{"412", typeof(Models.ErrorStatus)   },{"429", typeof(Models.ErrorStatus)   },{"500", typeof(Models.ErrorStatus)   } };
        ...
        public async Task<Response> DeleteLobbyAsync(Unity.Services.Lobbies.Lobby.DeleteLobbyRequest request,
            Configuration operationConfiguration = null)
        {
            var statusCodeToTypeMap = new Dictionary<string, System.Type>() { {"204",  null },{"400", typeof(Models.ErrorStatus)   },{"403", typeof(Models.ErrorStatus)   },{"404", typeof(Models.ErrorStatus)   },{"412", typeof(Models.ErrorStatus)   },{"429", typeof(Models.ErrorStatus)   },{"500", typeof(Models.ErrorStatus)   } };
        ...
        /// <returns>Task for a Response object containing status code, headers, and Models.MigrationDataInfo object.</returns>
        /// <exception cref="Unity.Services.Lobbies.Http.HttpException">An exception containing the HttpClientResponse with headers, response code, and string of error.</exception>
        public async Task<Response<Models.MigrationDataInfo>> GetMigrationDataInfoAsync(Unity.Services.Lobbies.Lobby.GetMigrationDataInfoRequest request,
            Configuration operationConfiguration = null)
        {
            var statusCodeToTypeMap = new Dictionary<string, System.Type>() { {"200", typeof(Models.MigrationDataInfo)   },{"400", typeof(Models.ErrorStatus)   },{"403", typeof(Models.ErrorStatus)   },{"404", typeof(Models.ErrorStatus)   },{"429", typeof(Models.ErrorStatus)   },{"500", typeof(Models.ErrorStatus)   } };
            ...
            var handledResponse = ResponseHandler.HandleAsyncResponse<Models.MigrationDataInfo>(response, statusCodeToTypeMap);
            return new Response<Models.MigrationDataInfo>(response, handledResponse);
        }
        ...
        public async Task<Response<Models.Lobby>> UpdateLobbyAsync(Unity.Services.Lobbies.Lobby.UpdateLobbyRequest request,
            Configuration operationConfiguration = null)
        {
            var statusCodeToTypeMap = new Dictionary<string, System.Type>() { {"200", typeof(Models.Lobby)   },{"400", typeof(Models.ErrorStatus)   },{"403", typeof(Models.ErrorStatus)   },{"404", typeof(Models.ErrorStatus)   },{"412", typeof(Models.ErrorStatus)   },{"429", typeof(Models.ErrorStatus)   },{"500", typeof(Models.ErrorStatus)   } };
